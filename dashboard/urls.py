...
urlpatterns = [
    ...
    path("ajax/icon-autocomplete", views.AjaxIconAutoComplete.as_view(), name="icon-autocomplete"),
    path("ajax/icon_form_table_menu", views.AjaxIconFormTableMenu.as_view(), name="icon_form_table_menu"),
]
